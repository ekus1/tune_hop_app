...
import 'package:tune_hop_app/components/button/more_info_button.dart';
    ...
    return Scaffold(
        appBar: PreferredSize(
            ...
            child: header(context,
                isHomePage: false, title: 'Težina igrice', subtitle: '')),
        body: Container(
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                moreInfoButton(context, width: 300.0, showAchievementsDialog: false),
                gameDifficultyButton(context,
                    text: 'Lagano',
                    route: '/difficulty/$data',
