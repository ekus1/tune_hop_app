...
import 'package:tune_hop_app/components/question/sound_question_component.dart';
import '../controller/question_controller.dart';
import '../models/question.dart';

class GuessTheSoundPage extends StatelessWidget {
  const GuessTheSoundPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) => SoundQuestionComponent(
